...
{
    public class ContratoPagamentoDetalheChequeVersao : ContratoPagamentoDetalheVersao, IObraPagamentoDetalheCheque
    {
        public ContratoPagamentoDetalheChequeVersao() : base() { }
