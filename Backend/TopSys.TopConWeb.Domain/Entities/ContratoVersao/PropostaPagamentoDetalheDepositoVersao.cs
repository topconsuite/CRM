...
{
    public class PropostaPagamentoDetalheDepositoVersao : PropostaPagamentoDetalheVersao, IObraPagamentoDetalheDeposito
    {
        public PropostaPagamentoDetalheDepositoVersao() : base() { }
