...
{
    public class PropostaPagamentoDetalheDinheiroVersao : PropostaPagamentoDetalheVersao, IObraPagamentoDetalheDinheiro
    {
        public PropostaPagamentoDetalheDinheiroVersao() : base() { }
