...
{
    public class ContratoPagamentoDetalheBoletoVersao : ContratoPagamentoDetalheVersao, IObraPagamentoDetalheBoleto
    {
        public ContratoPagamentoDetalheBoletoVersao() : base() { }
