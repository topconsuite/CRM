...
namespace TopSys.TopConWeb.Application.DTOS.Request.Opportunity.Alteracao
{

    public class OpportunityTypeAlteracaoRequest
    {
        public Guid Id { get; set; }
        public string Description { get; set; }
    }

    public class OpportunityFailureReasonAlteracaoRequest
    {
        public Guid Id { get; set; }
        public string Description { get; set; }
    }

    public class OpportunityOriginAlteracaoRequest
    {
        public Guid Id { get; set; }
        public string Description { get; set; }
    }
    ...
    public class OpportunityAlteracaoRequest
    {
        public Guid Id { get; set; }
