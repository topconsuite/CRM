...
{
    public class TipoDeCobrancaAtualizarRequest
    {
        ...
        [Range(0, 99, ErrorMessage = nameof(EResourcesDefaultMessages.DEFAULT_MESSAGES_LESS_THAN_ZERO_MORE_DIGITS_THAN_ALLOWED) + "::situation" + "::2")]
