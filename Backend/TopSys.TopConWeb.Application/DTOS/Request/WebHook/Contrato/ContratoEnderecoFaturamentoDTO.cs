...
{
    public class ContratoEnderecoFaturamentoDTO
    {
        public ContratoEnderecoFaturamentoDTO(string logradouro, string numero, string complemento, string bairro, int? municipioCodigo, string municipio, string uf, string cep)
        {
        ...
        public ContratoEnderecoFaturamentoDTO() { }
