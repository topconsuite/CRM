...
{
    public class ContratoAprovadoWebHookDTO
    {
        public ContratoAprovadoWebHookDTO(
        ...
        public static ContratoAprovadoWebHookDTO FromContrato(Domain.Entities.Contrato contrato, Domain.Entities.Obra obra)
        {
            ...
            foreach (var pagamento in obra.ContratoPagamentos)
            {
                ...
                if ((pagamento.Detalhes?.Count ?? 0) > 0) 
                {
            ...
            var contratoAprovadoWebHookDTO = new ContratoAprovadoWebHookDTO(
        ...
        public static ContratoAprovadoWebHookDTO FromContrato(Domain.Entities.ContratoVersao contrato, Domain.Entities.ObraVersao obra)
        {
            var pagamentosDTO = new List<ContratoPagamentoDTO>();
            foreach (var pagamento in obra.ContratoPagamentos)
            {
