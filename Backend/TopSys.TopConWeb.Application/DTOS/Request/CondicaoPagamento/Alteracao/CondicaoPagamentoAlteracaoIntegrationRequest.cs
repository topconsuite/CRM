...
{
    public class CondicaoPagamentoAlteracaoIntegrationRequest
    {
        [Required]
        ...
        public char? CondicaoDaCobrancaCod { get; set; } = null;
        ...
        public ECondicaoPagamentoDiaUltimoVencimento? DiaUtilDeVencimento { get; set; } = null;
        ...
        public List<int> TiposDeCobrancaCodigos { get; set; } = null;
    }
}
