...
{
    public class CondicaoPagamentoIntegrationResponse
    {
        [JsonProperty(PropertyName = CondicaoPagamentoIntegrationAttributesNames.Codigo)]
        ...
        public ECondicaoPagamentoDiaUltimoVencimento DiaUtilDeVencimento { get; set; }
        ...
        public List<int> TiposDeCobrancaCodigos { get; set; }
    }
}
