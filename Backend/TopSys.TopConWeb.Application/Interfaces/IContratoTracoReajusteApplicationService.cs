...
{
    public interface IContratoTracoReajusteApplicationService
    {
        IEnumerable<ContratoReajusteVigenciasResponse> ObterVigencias();
        PagedList<ContratoReajusteResponse> ListarContratoReajusteTracoPorPagina(int pagina, int porPagina, string filter);
