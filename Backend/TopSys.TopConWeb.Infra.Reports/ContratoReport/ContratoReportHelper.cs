...
{
    public static class ContratoReportHelper
    {
        public static ReportClass GetByRptName(string rptName)
        {
            switch (rptName.ToLower())
            {
                case "conr6111ctr.rpt":
                    return new ContratoReportCTR();
                case "conr6111realmix.rpt":
                    return new ContratoReportRealmix();
                case "conr6111concretiza.rpt":
                    return new ContratoReportConcretiza();
                case "conr6111giamix.rpt":
                    return new ContratoReportGiamix();
                case "conr6111sultepa.rpt":
                    return new ContratoReportSultepa();
                case "conr6111massafort.rpt":
                    return new ContratoReportMassaFort();
                case "conr6111impermix.rpt":
                    return new ContratoReportImpermix();
                case "conr6111superbase.rpt":
                    return new ContratoReportSuperbase();
                case "conr6111betmix.rpt":
                    return new ContratoReportBetmix();
                case "conr6111capitalmix.rpt":
                    return new ContratoReportCapitalMix();
                case "conr6111goldmix.rpt":
                    return new ContratoReportGoldmix();
                case "conr6111tracoforte.rpt":
                    return new ContratoReportTracoForte();
                case "conr6111fortemix.rpt":
                    return new ContratoReportFortemix();
                case "conr6111vale.rpt":
                    return new ContratoReportVale();
                case "conr6111santaefigenia.rpt":
                    return new ContratoReportSantaEfigenia();
                case "conr6111dotto.rpt":
                    return new ContratoReportDotto();
                case "conr6111ctrfornecimento.rpt":
                    return new ContratoReportCTRFornecimento();
                case "conr6111campeao.rpt":
                    return new ContratoReportCampeao();
                case "conr6111cbtk.rpt":
                    return new ContratoReportCBTK();
                case "conr6111concretize.rpt":
                    return new ContratoReportConcretize();
                case "conr6111superconcreto.rpt":
                    return new ContratoReportSuperConcreto();
                case "conr6111mendonca.rpt":
                    return new ContratoReportMendonca();
                case "conr6111concretarsc.rpt":
                    return new ContratoReportConcretarSC();
                case "conr6111concrebras.rpt":
                    return new ContratoReportConcrebras();
                case "conr6111usimix.rpt":
                    return new ContratoReportUsimix();
                case "conr6111newmix.rpt":
                    return new ContratoReportNewMix();
                case "conr6111concreserv.rpt":
                    return new ContratoReportConcreserv();
                case "conr6111cortesia.rpt":
                    return new ContratoReportCortesia();
                case "conr6111ciplan.rpt":
                    return new ContratoReportCiplan();
                case "contratoargamassareportmaxmohr.rpt":
                    return new ContratoArgamassaReportMaxMohr();
                case "contratoreportmaxmohr.rpt":
                    return new ContratoReportMaxMohr();
                case "contratoreporttrevisan.rpt":
                    return new ContratoReportTrevisan();
                case "contratoreportmaxmohrversao.rpt":
                    return new ContratoReportMaxMohrVersao();
                case "contratoargamassareportmaxmohrversao.rpt":
                    return new ContratoArgamassaReportMaxMohrVersao();
                case "versao.rpt":
                    return new ContratoReportDefaultVersao();
                case "contratoargamassareportconcrebras.rpt":
                    return new ContratoArgamassaReportConcrebras();
                case "contratoreportmassamix.rpt":
                    return new ContratoReportMassamix();
                default:
                    return new ContratoReportDefault();
            }
        }
        ...
        private static string GetCondicaoBombaString(Obra obra, string formulaName)
        {
            ...
            if (obra?.ObraBombas?.Count() >= bombaIndex)
            {
                ...
                if (obraBomba.TipoCalculo != EBombaM3CalculoTipo.SemCobranca)
                {
                    ...
                    mensagemBomba += $" Para bombeamentos inferiores a {obraBomba.RetornaVolumeM3()} m³ será cobrado taxa de R$ {string.Format("{0:#.00}", obraBomba.RetornaTaxaMinima())}";
                    mensagemBomba += $" e acima de {obraBomba.RetornaVolumeM3()} m³ serão cobrados R$ {string.Format("{0:#.00}", obraBomba.RetornaPrecoM3())} por m³ lançado";
        ...
        public static void ConfigurarContratoReport(ref ReportClass report, string rptName, int idUsinaContrato, int contratoAno, int contratoNumero, IObraService obraService, IObraTaxaService obraTaxaService, IEmpresaService empresaService, IParametroService parametroService, IContratoService contratoService, IContratoVersaoService contratoVersaoService, int tipo, bool estaGerandoNovaVersao, int versao = 0)
        {
            ...
            if (versao != 0)
                report.RecordSelectionFormula += ("{con_contrato.num_versao}=" + versao + " and ");
            ...
            var numProximaVersao = contratoService.GetUltimaVersaoContrato(idUsinaContrato, contratoAno, contratoNumero) + 1;
            var numVersao = "0";
            DateTime? dataVersaoCriada = null;
            ...
            {
                if (contratoVersaoService.ExisteVersaoEmAberto(obra?.UsinaCodigo ?? 0, obra?.AnoContrato ?? 0, obra?.NumContrato ?? 0))
                    estaGerandoNovaVersao = true;

                numVersao = Convert.ToString(numProximaVersao - (estaGerandoNovaVersao ? 2 : 1));
                dataVersaoCriada = contratoService.GetDataCriacaoVersaoContrato(numProximaVersao - (estaGerandoNovaVersao ? 2 : 1), idUsinaContrato, contratoAno, contratoNumero);
                if (dataVersaoCriada == null || dataVersaoCriada == DateTime.MinValue)
                {
                    dataVersaoCriada = obra.Contrato.DataContrato;
                }

                if ((report.ResourceName == "ContratoArgamassaReportConcrebras.rpt" || report.ResourceName == "ContratoReportConcrebras.rpt" || report.ResourceName == "ContratoReportMaxMohr.rpt" || report.ResourceName == "ContratoArgamassaReportMaxMohr.rpt" || report.ResourceName == "ContratoReportDefault.rpt") && !numVersao.Equals("0"))
                    report.RecordSelectionFormula += " AND {con_proposta_item_versao.num_versao}=" + numVersao;
             }
            //}

            var usinaClausula = contratoService.ObterUsinaClausula(obra.UsinaEntregaCodigo);
