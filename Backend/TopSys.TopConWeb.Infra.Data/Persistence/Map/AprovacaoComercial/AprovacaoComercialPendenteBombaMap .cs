...
{
    public class AprovacaoComercialPendenteBombaMap : EntityTypeConfiguration<AprovacaoComercialPendenteBomba>
    {

        public AprovacaoComercialPendenteBombaMap()
        {

            ToTable("con_aprovacao_comercial_pendente_bomba");
