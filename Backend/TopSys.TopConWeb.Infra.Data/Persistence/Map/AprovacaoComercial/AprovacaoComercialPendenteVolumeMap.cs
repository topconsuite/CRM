...
{
    public class AprovacaoComercialPendenteVolumeMap : EntityTypeConfiguration<AprovacaoComercialPendenteVolume>
    {

        public AprovacaoComercialPendenteVolumeMap()
        {

            ToTable("con_aprovacao_comercial_pendente_volume");
