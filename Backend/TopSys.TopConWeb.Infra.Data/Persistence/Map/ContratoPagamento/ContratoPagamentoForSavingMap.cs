...
{
    public class ContratoPagamentoForSavingMap : EntityTypeConfiguration<ContratoPagamentoForSaving>
    {
        public ContratoPagamentoForSavingMap()
        {
            ToTable("topsys.con_contrato_pag");
