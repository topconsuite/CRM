...
{
    public class ContratoBombaReajusteMap : EntityTypeConfiguration<ContratoBombaReajuste>
    {
        public ContratoBombaReajusteMap()
        {
            ToTable("topsys.con_reaj_bomba");

            HasKey(t => new { t.UsinaCodigo, t.ContratoAno, t.ContratoNumero, t.DataVigencia, t.ObraBombaReajusteSequencia });
