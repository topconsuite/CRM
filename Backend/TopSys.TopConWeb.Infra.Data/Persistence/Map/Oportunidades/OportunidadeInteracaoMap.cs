...
{
    public class OportunidadeInteracaoMap : EntityTypeConfiguration<OportunidadeInteracao>
    {
        public OportunidadeInteracaoMap()
        {
            ToTable("topsys.con_oportunidade_hist");
