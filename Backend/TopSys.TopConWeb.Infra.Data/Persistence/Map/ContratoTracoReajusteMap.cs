...
{
    public class ContratoTracoReajusteMap : EntityTypeConfiguration<ContratoTracoReajuste>
    {
    public ContratoTracoReajusteMap()
        {
            ToTable("topsys.con_reajuste_item");

            HasKey(t => new { t.UsinaCodigo, t.ContratoAno, t.ContratoNumero, t.DataVigencia, t.ObraTracoSequencia });
