...
{
    public class PropostaVersaoMap : EntityTypeConfiguration<PropostaVersao>
    {
        public PropostaVersaoMap()
        {
            ToTable("topsys.con_chtel_versao");

            Ignore(t => t.StatusProposta);

            HasKey(t => new { t.NumeroVersao, t.UsinaCodigo, t.Ano, t.Numero });
