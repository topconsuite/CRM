...
{
    public class TaxaExtraVersaoMap : EntityTypeConfiguration<TaxaExtraVersao>
    {
        public TaxaExtraVersaoMap()
        {
            ToTable("topsys.con_taxa_extra_versao");

            HasKey(t => new { t.NumeroVersao, t.UsinaCodigo, t.Sequencia, t.ObraCodigo });
