...
{
    public class PropostaPagamentoVersaoMap : EntityTypeConfiguration<PropostaPagamentoVersao>
    {
        public PropostaPagamentoVersaoMap()
        {
            ToTable("topsys.con_chtel_pag_versao");

            HasKey(t => new { t.NumeroVersao, t.UsinaCodigo, t.PropostaAno, t.PropostaNumero, t.ObraCodigo, t.Sequencia });
            ...
            HasMany(t => t.Detalhes)
                .WithRequired()
                .HasForeignKey(t => new { t.NumeroVersao, t.UsinaCodigo, t.PropostaAno, t.PropostaNumero, t.ObraCodigo, t.PagamentoSequencia });
        }
    }
}