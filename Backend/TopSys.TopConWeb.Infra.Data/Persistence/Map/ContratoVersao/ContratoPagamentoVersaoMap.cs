...
{
    public class ContratoPagamentoVersaoMap : EntityTypeConfiguration<ContratoPagamentoVersao>
    {
        public ContratoPagamentoVersaoMap()
        {
            ToTable("topsys.view_con_contrato_pag_versao");
