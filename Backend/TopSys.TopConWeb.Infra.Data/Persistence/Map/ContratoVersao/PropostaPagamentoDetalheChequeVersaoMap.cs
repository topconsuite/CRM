...
{
    public class PropostaPagamentoDetalheChequeVersaoMap : EntityTypeConfiguration<PropostaPagamentoDetalheChequeVersao>
    {
        public PropostaPagamentoDetalheChequeVersaoMap()
        {
