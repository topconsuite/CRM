...
{
    class PropostaResponsavelSolidarioVersaoMap : EntityTypeConfiguration<PropostaResponsavelSolidarioVersao>
    {
        public PropostaResponsavelSolidarioVersaoMap()
        {
            ToTable("topsys.con_chtel_resp_solid_versao");
