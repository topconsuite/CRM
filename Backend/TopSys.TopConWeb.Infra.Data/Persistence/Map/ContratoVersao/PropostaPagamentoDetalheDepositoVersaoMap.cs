...
{
    public class PropostaPagamentoDetalheDepositoVersaoMap : EntityTypeConfiguration<PropostaPagamentoDetalheDepositoVersao>
    {
        public PropostaPagamentoDetalheDepositoVersaoMap()
        {
            //ToTable("view_con_chtel_dep_versao");
