...
{
    public class PropostaCobrancaVersaoMap : EntityTypeConfiguration<PropostaCobrancaVersao>
    {
        public PropostaCobrancaVersaoMap()
        {
            ToTable("topsys.con_chtel_cobranca_versao");

            HasKey(t => new { t.NumeroVersao, t.UsinaCodigo, t.PropostaAno, t.PropostaNumero });

            HasRequired(t => t.Proposta)
                .WithOptional(t => t.Cobranca);
