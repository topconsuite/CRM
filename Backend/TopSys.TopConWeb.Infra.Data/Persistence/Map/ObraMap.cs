...
namespace TopSys.TopConWeb.Infra.Data.Persistence.Map
{
    public class ObraMap : EntityTypeConfiguration<Obra>
    {
        public ObraMap()
        {
            ...
            HasKey(t => new { t.UsinaCodigo, t.Numero});

            HasOptional(t => t.Contrato)
                .WithMany()
                .HasForeignKey(t => new { t.UsinaCodigo, t.AnoContrato, t.NumContrato })
                .WillCascadeOnDelete(false);

            HasOptional(t => t.Proposta)
                .WithMany()
                .HasForeignKey(t => new { t.UsinaCodigo, t.AnoChamada, t.NumChamada })
                .WillCascadeOnDelete(false);
            ...
            HasMany(t => t.ObraProjecao)
                .WithRequired(t => t.Obra)
                .HasForeignKey(t => new { t.Usina, t.NoObra });
            ...
            HasMany(t => t.ObraMensagensPadrao)
                .WithRequired()
                .HasForeignKey(t => new { t.UsinaCodigo, t.ObraNumero });

            HasMany(t => t.ObraTributacoesMunicipais)
                .WithRequired()
                .HasForeignKey(t => new { t.ObraUsinaCodigo, t.ObraNumero });
